...
if __name__ == '__main__':
    ...
    adjective = simpledialog.askstring(title='Greeter', prompt='put in an adjective')
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title='Greeter', prompt='put in a liquid')
    # Get the player to enter a body part
    bodypart = simpledialog.askstring(title='Greeter', prompt='put in a body part')
    # Get the player to enter a verb
    verb = simpledialog.askstring(title='Greeter', prompt='put in a verb')
    # Get the player to enter a place
    place = simpledialog.askstring(title='Greeter', prompt='put in a place')
    ...
    story = (
        ...
        "likely take a bite out of your a body part if you verb. Whatever\n"
    ...
    messagebox.showinfo(message="Piranhas are more  during the day, so cross the river at\n"
        "night. Piranhas are attracted to fresh liquid and will most\n"
        "likely take a bite out of your a body part if you verb. Whatever\n"
        "you do, if you have an open wound, try to find another way to get "
        "back to the place. Good luck!")
